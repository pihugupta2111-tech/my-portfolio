...
const PhotoshopIcon = () => (
  <svg viewBox="0 0 24 24" fill="currentColor" width="64" height="64">
    ...
    <text x="50%" y="50%" dominantBaseline="middle" textAnchor="middle" fill="white" fontSize="14" fontWeight="bold">Ps</text>
  </svg>
);
...
const IllustratorIcon = () => (
  <svg viewBox="0 0 24 24" fill="currentColor" width="64" height="64">
    ...
    <text x="50%" y="50%" dominantBaseline="middle" textAnchor="middle" fill="white" fontSize="14" fontWeight="bold">Ai</text>
  </svg>
);
...
const InDesignIcon = () => (
  <svg viewBox="0 0 24 24" fill="currentColor" width="64" height="64">
    ...
    <text x="50%" y="50%" dominantBaseline="middle" textAnchor="middle" fill="white" fontSize="14" fontWeight="bold">Id</text>
  </svg>
);
...
const CorelIcon = () => (
  <svg viewBox="0 0 24 24" fill="currentColor" width="64" height="64">
    ...
    <text x="50%" y="50%" dominantBaseline="middle" textAnchor="middle" fill="white" fontSize="14" fontWeight="bold">Co</text>
  </svg>
);

const skills = [
  { name: "Graphics Designing", icon: PaletteIcon, color: "from-purple-500 to-pink-500" },
  { name: "Package Design", icon: BoxIcon, color: "from-blue-500 to-cyan-500" },
  { name: "Poster Design", icon: FileImageIcon, color: "from-orange-500 to-red-500" },
  { name: "Manipulation", icon: MagicIcon, color: "from-green-500 to-emerald-500" },
  { name: "Logo Design", icon: AwardIcon, color: "from-yellow-500 to-orange-500" },
  { name: "Product Branding", icon: TagsIcon, color: "from-indigo-500 to-purple-500" },
  { name: "Digital Marketing", icon: BullhornIcon, color: "from-pink-500 to-rose-500" }
];
            ...
            return (
              ...
              >
                <div style={{
                  ...
                  borderRadius: "16px",
                  padding: "30px",
                  border: isHovered ? "2px solid transparent" : "2px solid rgba(71, 85, 105, 0.5)",
                  boxShadow: isHovered ? "0 20px 60px rgba(0,0,0,0.5)" : "0 4px 6px rgba(0,0,0,0.1)",
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    <div style={{
                      ...
                      transition: "transform 0.3s ease",
                      filter: isHovered ? "drop-shadow(0 0 20px " + tool.color + ")" : "none"
                    }}>
                      <Icon />
                    </div>
